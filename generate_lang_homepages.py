...
LANGS = {
    'it': {
        ...
        'hero_h1': 'In vela a bordo di<br><em>S/V Oroboro</em>',
        ...
        'view_all': 'Vedi tutti gli 87 articoli →',
    ...
    'fr': {
        ...
        'view_all': 'Voir tous les 87 articles →',
    ...
    'pt': {
        ...
        'view_all': 'Ver todos os 87 artigos →',
    ...
    'es': {
        ...
        'view_all': 'Ver todos los 87 artículos →',
    ...
    'ca': {
        ...
        'view_all': 'Veure els 87 articles →',
...
def generate_homepage(lang, cfg):
    ...
    src = src.replace('<a class="btn-outline" href="/blog.html">View all 87 posts →</a>',
